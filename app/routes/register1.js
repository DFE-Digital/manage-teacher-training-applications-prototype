...
module.exports = router => {
  ...
  router.get('/register1/:organisationId/start', (req, res) => {
    ...
    res.render('register/v1/start', {
      actions: {
        next: `/register1/${req.params.organisationId}/providers/${trainingProviderId}`
      },
  ...
  router.get('/register1/:organisationId/providers/:providerId', checkHasAnswers, (req, res) => {
    ...
    let save = `/register1/${req.params.organisationId}/providers/${req.params.providerId}`
    ...
    let back = `/register1/${req.params.organisationId}/start`
    ...
    if (req.query.referer == 'check-your-answers') {
      back = `/register1/${req.params.organisationId}/check-your-answers`
    } else {
      ...
      if (position > 0) {
        ...
        // set the back link
        back = `/register1/${req.params.organisationId}/providers/${previousProviderId}`
      }
    }
  ...
  router.post('/register1/:organisationId/providers/:providerId', checkHasAnswers, (req, res) => {
    // get the position of the current provider id
    const position = req.session.data.registration.trainingProvidersIds.indexOf(req.params.providerId)
    ...
    if (req.query.referer == 'check-your-answers') {
      ...
      res.redirect(`/register1/${req.params.organisationId}/check-your-answers`)
    } else {
      ...
      if (position == (req.session.data.registration.trainingProviders.length - 1)) {
        ...
        // redirect to the data sharing agreement
        res.redirect(`/register1/${req.params.organisationId}/agreement`)
        ...
        res.redirect(`/register1/${req.params.organisationId}/providers/${nextTrainingProviderId}`)
      }
    }
  })

  router.get('/register1/:organisationId/agreement', checkHasAnswers, (req, res) => {
    const lastTrainingProviderId = req.session.data.registration.lastTrainingProviderId

    res.render('register/v1/agreement', {
      actions: {
        save: `/register1/${req.params.organisationId}/agreement`,
        back: `/register1/${req.params.organisationId}/providers/${lastTrainingProviderId}`
      },
      accreditingBody: req.session.data.registration.accreditingBody
    })
  })

  router.post('/register1/:organisationId/agreement', checkHasAnswers, (req, res) => {
    const errors = []
  ...
  router.get('/register1/:organisationId/check-your-answers', checkHasAnswers, (req, res) => {
    res.render('register/v1/check-your-answers', {
      actions: {
        next: `/register1/${req.params.organisationId}/done`,
        back: `/register1/${req.params.organisationId}/agreement`
      },
      registration: req.session.data.registration
    })
  })

  router.get('/register1/:organisationId/done', checkHasAnswers, (req, res) => {
