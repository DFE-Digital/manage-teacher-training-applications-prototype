...
const generateFakeApplications = () => {
  ...
  applications.push(generateFakeApplication({
    ...
    schoolExperience: [],
    personalStatement: {
      vocation: "During my school days it was my maths teacher who inspired and taught me to love maths. I discovered that through good teaching methods and stirring up a student’s love and passion for learning anything is possible. I learned from this teacher that mathematics is fun and not as horrible as I thought, the hatred for mathematics was replaced by love and interest to study and practice. This inspired and made me develop an interest in teaching to help students who might be having similar issues. When I studied maths at university, I discovered that with the right teaching methods, love, patience, understanding, and helping the students develop love and interest in learning, there is virtually no student that can’t learn mathematics. Sound knowledge of the concepts by the teacher builds his/her confidence and also builds the student's trust in the teacher which in turn motivates them to learn. From working at a university (although I was a researcher) I learned that a lot is expected from teachers as students look up to them as role models and mentors and as such, it is expected that the teacher should be a person of integrity. Because of this I try and model the right attitudes and virtues to every student I have come in contact with at my job. From being both a librarian and researcher, I have also discovered that learning is not limited to the four walls of the classroom and learning can take place anywhere and anytime. Students tend to retain information or ideas learned during fun or personal discovery for a longer period, so extracurricular activities also help to produce a balanced student and I believe it is an important aspect of learning. The education system and curriculum should have the well-being and development of the child at their centre. The interest and wholesome development of the child should be the goal of educational policies and the curriculum. Having children who are developed in all areas will eventually result in an organised and a developed society. I strongly believe that obtaining the Qualified Teachers Status certificate will boost and increase my chances of working and impacting the lives of students.",
      subjectKnowledge: "I studied mathematics at the university. This helped to sharpen my critical thinking skills and also aided my reasoning. I naturally appreciate numbers and possess a strong affinity for patterns and logic. I am familiar with the curriculum and I have prepared my own children for their own maths exams. I have also informally helped students at the university with their lessons and mathematical concepts. These experiences have enabled me to acquire the necessary skills to excel as a teacher. Having good communication skills and being an adept listener have given me room for mutual understanding and improved student-teacher relationships. I enjoy working with students in my current role as a university researcher. I believe that this stage of their life is crucial in making career decisions, and I love to see that they do not allow their former hatred for mathematics to stop them from pursuing their careers."
    },
    safeguarding: {
      response: false
    },
  ...
  applications.push(generateFakeApplication({
    ...
    personalStatement: {
      vocation: "My primary motivation for wanting to become a teacher is that I love working with children and supporting them in developing as individuals and reaching their full potential. I believe teaching would be an enjoyable and rewarding career for me and one to which I am well-suited. I received advice from a Teaching Advisor that becoming a teacher would be the best way to pursue a career in education and one that was open to me as a holder of a Mathematics degree. After reflection on this advice I came to the conclusion that this was something I was interested in. My first experience of working with children was as a support worker at a community centre in my area. During my time at the centre I had the privilege to work with a wide range of students and learned a huge amount about working with young people. My work as a support worker (both with adults and children) has required me to support people in accessing their communities and taking part in outings and activities of a wide variety. I also have led after school and lunchtime clubs related to my own interests, including maths and music. I believe this experience would be invaluable in contributing to a school inside and outside the classroom. In addition, my experience as a performer has helped me build the confidence to stand in front of a classroom. I have also received extensive training in safeguarding and behaviour support having worked with adults and children with SEND for many years. I believe it is paramount to the development of healthy and happy young people that the professionals working with them are good role-models, and that with vigilance, dedication and compassion a teacher can make a huge difference to their lives. It would be an enormous honour to be given the opportunity to become a teacher.",
      subjectKnowledge: "Mathematics has always been one of my strongest subjects and I chose to study this subject at A-Level and for my degree because of the satisfaction I gained from working through complex problems. I am already confident with the curriculum so I feel I am well placed to teach it. I studied a BSc in Maths at Leeds University and I found the subjects I studied fascinating and this knowledge of high-level Mathematics would be beneficial when working with students who have the ability and inclination to take their study of the subject further. I also have experience of organising and delivering a study clubs to groups of SEND students at a community centre in my area. This was enormously rewarding, particularly in the way I saw the students develop and begin to enjoy the practice over many months. I have had a lifelong interest in music. I have played and sung in various different groups over the years in front of many audiences, and this has helped me build confidence in public speaking and presentation. I am always keen to inspire and encourage a love for music in young people and would welcome any opportunities a career in teaching presented me with to do this."
    }
  }))
